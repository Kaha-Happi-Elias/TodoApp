        ...
        <div class="row">
            <div class="col">
                ...
                <form action="/update/traitement" method="POST">
                    @csrf
                    <input type="text" name="id" style="display: none;" value="{{ $items->id }}">
                    <div class="row">
                        <div class="col-25">
                            <label for="Titre" class="form-label">Titre</label>
                        </div>
                        <div class="col-75">
                            <input type="text" class="form-control" id="Titre" name="titre" value="{{ $items->titre }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-25">
                        ...
                        <div class="col-75">
                            <textarea name="description" id="Description" value="{{ $items->description }}" style="height:200px"></textarea>
                        </div>
                    </div>
                    <br>
